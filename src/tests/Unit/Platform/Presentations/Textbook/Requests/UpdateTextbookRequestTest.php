...
class UpdateTextbookRequestTest extends TestCase
{
    ...
    public function test_必須項目が正しく入力されている場合バリデーションが成功する()
    {
        ...
        $request = UpdateTextbookRequest::create('', 'PUT', $inputData);
    ...
    {
        //given
        $request = UpdateTextbookRequest::create('', 'PUT', $input);
    ...
    private static function createDefaultInput(
        ?string $name = 'テスト教科書（更新）',
        ?int $price = 1500,
        ?string $description = 'テスト説明（更新）',
        ...
        array $image_ids = ['00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000004'],
    ): array {
        return compact(
            'name',
            'price',
